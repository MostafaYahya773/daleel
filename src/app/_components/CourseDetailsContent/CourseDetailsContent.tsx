...
const CourseDetailsContent = ({
  ...
  return (
    <div className="grid md:grid-cols-[1fr_auto] grid-cols-1 gap-5">
      ...
      <div className="md:w-[350px]  w-full bg-white shadow-lg rounded-md overflow-hidden flex flex-col ">
        ...
        <div className="p-4">
          <div className="whatYouLearn flex flex-col gap-5">
            ...
            <p
              className={`${
                price === 0 && 'hidden'
              } text-therd font-bold text-[30px] text-center`}
            >{`${price} جنيه`}</p>
